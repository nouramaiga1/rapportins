...
data = pd.read_csv("https://raw.githubusercontent.com/nouramaiga1/pictures/refs/heads/main/iasembleokautiliser.csv")
...
filtered_data = data[
    ...
    (data["initial_size"] == selected_initial_size) &
    (data["ai_size"] == selected_ai_size) &
