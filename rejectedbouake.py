...
data = pd.read_csv("https://raw.githubusercontent.com/nouramaiga1/pictures/refs/heads/main/rejectednodupbouake.csv")

st.set_page_config(layout="wide")

st.write("## Photos des activités rejetées - Bouake")
