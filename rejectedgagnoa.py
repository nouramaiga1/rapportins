...
data = pd.read_csv("https://raw.githubusercontent.com/nouramaiga1/pictures/refs/heads/main/rejectednodupgagnoa.csv")

st.set_page_config(layout="wide")

st.write("## Photos des activités rejetées - Gagnoa")
